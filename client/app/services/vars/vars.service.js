...
var VarsService = (function () {
    //inject http module into the constructor
    function VarsService(http) {
        this.http = http;
        console.log('vars service');
    }
    VarsService.prototype.getVars = function () {
        //we want to return the data as json
        return this.http.get('/vars').map(function (res) { return res.json(); });
    };
    VarsService = __decorate([
        core_1.Injectable(),
...
//# sourceMappingURL=vars.service.js.map